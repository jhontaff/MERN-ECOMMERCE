...
const data = {
  ...
  products: [
...

    {
      ...
      numReviewes: 15,
      description:
        'Ofrece una velocidad de 1167Mbps. Banda doble de 2.4 GHz y 5 GHz. Posee 4 antenas externas. Tiene 5 puertos para conectarse. Con firewall integrado. Soporta los protocolos de seguridad WPS, DMZ, WPA, WPA2, NAT. Dispositivo que facilita conexión a la red.',
    },

    {
      ...
      numReviewes: 21,
      description:
        'Con el router Asus GT-AC2900 podrás establecer redes potentes para enviar y recibir información a gran velocidad. Con este equipo inalámbrico podrás desplazarte con total libertad por tu casa u oficina y disfrutar de la conexión sin estar pendiente de los cables. Con este dispositivo, las paredes y techos no son un obstáculo: los múltiples receptores garantizan un mejor rendimiento en lugares con gran nivel de interferencia.',
    },
    ...
    //ANTENAS
    {
      ...
      numReviewes: 14,
      description:
        'El PowerBeam 5AC Gen 2 dirige la energía de RF en un ancho de haz más ajustado. Con el foco en una dirección, el PowerBeam 5AC Gen 2 bloquea o espacia el ruido, por lo que se mejora la inmunidad al ruido. Esta característica es especialmente importante en un área atestada de otras señales de RF de la misma frecuencia o similar.',
    },
...

    {
      ...
      numReviewes: 18,
      description:
        'Antena satelital 78 centímetros incluye LNB universal de 2 salidas',
    },
